...
task :deep_maintenance => ['vagrant:delete_all_virtualbox_vagrant_boxes', 'vagrant:delete_obsolete_virtualbox_vagrant_master_vms', 'vagrant:clean_virtualbox_vms_folder', 'vagrant:download_common_vagrant_boxes']
